...
object SimpleApp {
    def main(args: Array[String]): Unit = {
        ...
        val tofromscala = Native.loadLibrary("./tofromscala.so", classOf[SimpleJavaApp.Awesome]/*, options*/).asInstanceOf[SimpleJavaApp.Awesome]
        ...
        val arr = new Memory(nums.length * Native.getNativeSize(java.lang.Long.TYPE))
        ...
        val callbackParamImpl = new SimpleJavaApp.Awesome.NotificationParamListenerImpl
